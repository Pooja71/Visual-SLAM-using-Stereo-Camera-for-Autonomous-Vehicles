...
// The following libraries are required for publishing Mappoints on topic as PCL
#include<ros/ros.h>
...
// Converting depth man to laser scan.
...
public:
    // Attributes
    // HashMap to save <keyframe id, laserscan>.
    ...
    std::unordered_map<long unsigned int, sensor_msgs::LaserScanPtr> GetKeyFrameLaserScanMap();
